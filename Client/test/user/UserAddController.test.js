describe('Testing the UserAddController', function() {
    ...
    beforeEach(function() {
        ...
        userService = jasmine.createSpyObj('userService',['add']);
    ...
    beforeEach(inject(function($controller, $rootScope) {
        ...
        describe('Add : ', function(){
            ...
            it('Verify if the confirm password fail', function () {
                userService.add.and.returnValue(defer.promise);
            ...
            it('Verify the user sent to the service', function () {
                ...
                expect(userService.add).toHaveBeenCalledWith(createCorrectUser());
            });
