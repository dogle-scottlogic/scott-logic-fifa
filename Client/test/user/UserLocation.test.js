describe('Testing the user locations', function() {
  ...
  beforeEach(function() {
    ...
    module(function($provide) {
      ...
      // defining the method getUserList for the service used by the controller
  ...
  describe('Testing the user location : ', function(){
    ...
    it('Location /users shall call userService.getUserList() in order to init the list', function() {

      // Spying the userService for the method getUserList which will return a promise
      spyOn(userService, 'getUserList').and.returnValue(defer.promise);
      ...
      // Verfiying that on init the getUserList of the service is called
    ...
    it('Location /users/edit/1 shall call userService.getUser() in order to init the user', function() {

      // Spying the userService for the method getUserList which will return a promise
      spyOn(userService, 'getUser').and.returnValue(defer.promise);
      // Creating a fake view in order to have then the location diplayed in this
      var html = angular.element('<ng-view></ng-view>');
      var element = compile(html)(rootScope.$new());
